...
/* Mailbox Write-set (write only) regs */
#define CORE0_MBOX0_WRITE_SET   (LOCAL_PERIPHERALS_BASE + 0x0080)
#define CORE0_MBOX1_WRITE_SET   (LOCAL_PERIPHERALS_BASE + 0x0084)
#define CORE0_MBOX2_WRITE_SET   (LOCAL_PERIPHERALS_BASE + 0x0088)
#define CORE0_MBOX3_WRITE_SET   (LOCAL_PERIPHERALS_BASE + 0x008C)
